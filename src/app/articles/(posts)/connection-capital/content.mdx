...
export const tags = ['team culture', 'management'];
export const summary =
  'Connection capital is the trust, empathy, and rapport that team members build with each other over time. Here are some ways to build and lose connection capital in remote teams.';
...
making everyone comfortable and never getting anything done. I contend that
