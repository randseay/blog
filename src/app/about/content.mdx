...
After nearly five years with Google, I left to rejoin the startup world,
spending three years leading teams at [Dispel](https://dispel.com) in the
cybersecurity space. We focused on protecting critical infrastructure through
zero-trust remote access and moving target defense.

In August 2025, I joined [ngrok](https://ngrok.com) as a Staff Front-End
Engineer. I help drive frontend architecture and implementation, focusing on
building performant, scalable, and accessible user interfaces. I partner closely
with engineering and product teams to deliver developer-focused tooling while
evolving [Mantle](https://mantle.ngrok.com/), our open-source component library.
