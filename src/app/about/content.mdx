...
I love backpacking, hiking, and camping. I'm an avid reader, and enjoy science
fiction and fantasy. I'm a hobby woodworker, cook as much as possible, and love
playing sports such as basketball and ultimate frisbee.

## My Professional Journey

My formal education is from the University of North Dakota, where I received my
Bachelor of Fine Arts in Graphic Design & New Art Media. After a successful as a
graphic designer at the local ad agency, I wanted badly to create a portfolio
site for myself, so I dove headlong into learning web development.
...
in 2013. Additionally, I became a father and cofounded a development and design
...
early contributor in helping to make data science accessible to everyone. In
this role I implemented and cared for front-end architecture and codebase and
spearheaded responsive design tooling and techniques.

After Kaggle was acquired by [Google Cloud](https://cloud.google.com/) in March
2017, I remained on board as a contributor within the community engineering
team. I worked on features such as discussions, administrator tooling,
documentation, and authentication flows.

As the world was shutting down in April 2020, I transferred within Google Cloud
to [BigQuery](https://cloud.google.com/bigquery), where I helped contributed to
the SQL-like workbench that data analysts used to interact with their data
warehouse. At this point in time my wife and I moved our family to the greater
Seattle area.
